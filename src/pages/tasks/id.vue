...
<template>
  <AppHeader />
  <div class="p-6 md:p-8 max-h-[calc(100dvh-116px)] overflow-y-auto flex flex-col gap-6">
    <div class="bg-white rounded-base h-full">
      ...
      <div class="p-6 space-y-6">
        ...
        <!-- Description -->
        <section>
          <h3 class="title-lg md:title-xl text-secondary-500 mb-4">Description</h3>
          <p class="text-thin md:text-sm text-secondary-500 font-normal leading-[200%]">
        ...
        <section class="space-y-5">
          <h3 class="title-lg md:title-xl text-secondary-500">Essence of Assessment</h3>
          <li
            class="flex-center gap-2.5 text-secondary-500 text-thin md:text-sm font-medium leading-[200%]"
